...
import com.tender.hellojack.business.start.StartActivity;
...
public class NimApplication extends Application {
    ...
    private SDKOptions options() {
        ...
        config.notificationEntrance = StartActivity.class; // 点击通知栏跳转到该Activity
        config.notificationSmallIconId = R.mipmap.hj_ic_launcher;
        // 呼吸灯配置
