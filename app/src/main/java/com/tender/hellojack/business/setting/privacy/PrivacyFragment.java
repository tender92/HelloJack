...
public class PrivacyFragment extends BaseFragment implements PrivacyContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.hj_fragment_privacy, container, false);
