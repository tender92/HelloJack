...
public class BiuBikeFragment extends BaseFragment implements BiuBikeContract.View {

    private BiuBikeContract.Presenter mPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.hj_fragment_biu_bike, container, false);
    ...
    @Override
    public void setPresenter(BiuBikeContract.Presenter presenter) {
