...
abstract public class CheckPermissionsActivity extends BaseActivity {
    //高德定位所需要的权限
    ...
    public void requestPermissions(Activity activity, String[] permissions, CheckPermissionsListener listener){
        ...
        if (!deniedPermissions.isEmpty()){
            ActivityCompat.requestPermissions(this, permissions, IntentConst.IRCode.SDK_PERMISSION_REQUEST);
        } else {
            //所有权限都已经同意了
            mListener.onGranted();
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        switch (requestCode){
            case IntentConst.IRCode.SDK_PERMISSION_REQUEST:
                List<String> deniedPermissions = new ArrayList<>();
