...
public class StatisticsManager implements IManager {
    ...
    private StatisticsManager(boolean statisticsFuncActive, boolean shareFunActive) {
        useStatistics = statisticsFuncActive;
        useShare = shareFunActive;
    }

    public static StatisticsManager getInstance(boolean statisticsFuncActive, boolean shareFunActive) {
        if (instance == null) {
            instance = new StatisticsManager(statisticsFuncActive, shareFunActive);
        }
        return instance;
    }
    ...
    private boolean isStatisticsFuncActive() {
        return instance.useStatistics;
    }

    private boolean isShareFunActive() {
        return instance.useShare;
    }
}
