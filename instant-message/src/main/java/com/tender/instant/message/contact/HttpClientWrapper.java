package com.tender.instant.message.contact;
...
public class HttpClientWrapper {
    ...
    public static HttpResult<String> get(final String urlStr, final Map<String, String> headers) {
        TenderLog.d("http get url=" + urlStr);
        ...
        try {
            ...
            if (resCode == RES_CODE_SUCCESS) {
                ...
                TenderLog.d("http get success, result=" + result.obj + ", url=" + urlStr);
            } else {
                TenderLog.e("http get failed, code=" + resCode + ", url=" + urlStr);
            }
        } catch (IOException e) {
            e.printStackTrace();
            result.e = e;
            TenderLog.e("http get error, e=" + e.getMessage() + ", url=" + urlStr);
        } finally {
    ...
    public static <T> HttpResult<String> post(final String urlStr, final Map<String, String> headers, T body) {
        TenderLog.d("http post url=" + urlStr);
        HttpResult<String> result = new HttpResult<>();
        ...
        try {
            ...
            if (resCode == RES_CODE_SUCCESS) {
                result.obj = buildString(urlConnection.getInputStream());
                TenderLog.d("http post success, result=" + result + ", url=" + urlStr);
            } else {
                TenderLog.e("http post failed, code=" + resCode + ", url=" + urlStr);
            }
        } catch (IOException e) {
            e.printStackTrace();
            result.e = e;
            TenderLog.e("http post error, e=" + e.getMessage() + ", url=" + urlStr);
        } finally {
            if (urlConnection != null) {
                urlConnection.disconnect();
            }
