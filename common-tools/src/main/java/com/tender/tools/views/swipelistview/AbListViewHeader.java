...
//		arrowImage = AbFileUtil.getBitmapFormSrc("image/arrow.png");
		arrowImage=new BitmapFactory().decodeResource(mContext.getResources(), R.mipmap.hj_tools_arrow_down);
		...
		switch(state){
			case STATE_NORMAL:
				...
				if(lastRefreshTime==null){
					lastRefreshTime = TimeUtils.getCurrentDate(TimeUtils.DEFAULT_PATTERN);
