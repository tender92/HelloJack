...
package com.tender.tools.views.swipelistview;
...
public class SwipeListView extends AbPullListView implements OnScrollListener {
	...
	/**
	 * android.widget.ListView#ListView(android.content.Context,
	...
	private void init(AttributeSet attrs) {
		...
		if (attrs != null) {
			TypedArray styled = getContext().obtainStyledAttributes(attrs,
					R.styleable.hj_tools_SwipeListView);
			swipeMode = styled.getInt(R.styleable.hj_tools_SwipeListView_hj_tools_swipeMode,
					SWIPE_MODE_BOTH);
			swipeActionLeft = styled.getInt(
					R.styleable.hj_tools_SwipeListView_hj_tools_swipeActionLeft,
					SWIPE_ACTION_REVEAL);
			swipeActionRight = styled.getInt(
					R.styleable.hj_tools_SwipeListView_hj_tools_swipeActionRight,
					SWIPE_ACTION_REVEAL);
			swipeOffsetLeft = styled.getDimension(
					R.styleable.hj_tools_SwipeListView_hj_tools_swipeOffsetLeft, 0);
			swipeOffsetRight = styled.getDimension(
					R.styleable.hj_tools_SwipeListView_hj_tools_swipeOffsetRight, 0);
			swipeOpenOnLongPress = styled.getBoolean(
					R.styleable.hj_tools_SwipeListView_hj_tools_swipeOpenOnLongPress, true);
			swipeAnimationTime = styled.getInteger(
					R.styleable.hj_tools_SwipeListView_hj_tools_swipeAnimationTime, 0);
			swipeCloseAllItemsWhenMoveList = styled.getBoolean(
					R.styleable.hj_tools_SwipeListView_hj_tools_swipeCloseAllItemsWhenMoveList,
					true);
			swipeDrawableChecked = styled.getResourceId(
					R.styleable.hj_tools_SwipeListView_hj_tools_swipeDrawableChecked, 0);
			swipeDrawableUnchecked = styled.getResourceId(
					R.styleable.hj_tools_SwipeListView_hj_tools_swipeDrawableUnchecked, 0);
			swipeFrontView = styled.getResourceId(
					R.styleable.hj_tools_SwipeListView_hj_tools_swipeFrontView, 0);
			swipeBackView = styled.getResourceId(
					R.styleable.hj_tools_SwipeListView_hj_tools_swipeBackView, 0);
		}
	 ...
	 *            Position that you want open
	 */
	public void openItemAnimate(int position) {
		touchListener.openItemAnimate(position);
	}
	...
	protected void onOpened(int position, boolean toRight) {
		if (select_position != 0 && select_position != position) {
			this.closeAnimate(select_position);
		}
