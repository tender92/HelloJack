...
public class SwipeListViewTouchListener implements View.OnTouchListener {
	 ...
	 *            Position of list
	 */
	protected void openItemAnimate(int position) {
		if (viewWidth < 2) {
			viewWidth = swipeListView.getWidth();
		}
		View child = swipeListView.getChildAt(position
				- swipeListView.getFirstVisiblePosition());
		setParentView(child);

		View frontView = child.findViewById(swipeFrontView);
		setFrontView(frontView);

		openAnimate(frontView, position);
	}
	...
	private void generateAnimate(final View view, final boolean swap,
		...
		TenderLog.d("swap: " + swap + " - swapRight: " + swapRight
				+ " - position: " + position);
	...
	public AbsListView.OnScrollListener makeScrollListener(
		...
		return new AbsListView.OnScrollListener() {
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				...
				slv.mTotalItemCount = totalItemCount;
	...
	public boolean onTouch(View view, MotionEvent motionEvent) {
		...
		case MotionEvent.ACTION_UP: {
			...
			if (minFlingVelocity <= velocityX && velocityX <= maxFlingVelocity
				...
				TenderLog.d("swapRight: " + swapRight + " - swipingRight: "
						+ swipingRight);
		...
		case MotionEvent.ACTION_MOVE: {
			...
			if (deltaMode > slop
				...
				TenderLog.d("deltaX: " + deltaX + " - swipingRight: "
						+ swipingRight);
				if (opened.get(downPosition)) {
